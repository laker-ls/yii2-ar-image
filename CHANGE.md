...
- Изменено. В поле загрузки изображений теперь отображаются миниатюры уже изображений для оптимизации.
- Изменено. Название изображений больше не отображается в инпуте загрузок изображений.
- Изменено. Карточки в поле загрузки изображений имеют меньшие отступы, кнопка удаления перенесена в угол, поверх изображения.
- Исправлено. Изображения с точками в имени не загружались.
- Убрано. Варианты отображения очень маленьких и очень больших миниатюр более недоступны.
